      ...
      <header className="w-full border-b border-black/10 dark:border-white/10 z-10 bg-transparent">
        <div className="px-6 md:px-12 py-4 flex items-center justify-between max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-bold tracking-tight">ReactLogin</h2>
          </div>
        ...
        >
          ...
          <div className="bg-white dark:bg-surface-dark rounded-xl shadow-2xl border border-black/5 dark:border-white/5 p-8 sm:p-10">
            ...
            <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
              ...
              <div className="flex justify-end">
                <a href="#" className="text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-primary transition-colors">Forgot Password?</a>
              </div>
          ...
          <div className="text-center">
            <p className="text-slate-600 dark:text-slate-400">
              ...
              <Link to="/signup" className="font-bold text-primary hover:text-green-300 ml-1 transition-colors">Sign up for free</Link>
            </p>
          </div>
        </motion.div>
      </main>
